...
enum RingtoneCatalog {
    ...
    static let all: [Ringtone] = [
        ...
        Ringtone(id: "classic.bedsideclock", displayNameKey: "ringtone_classic_bedsideclock", section: .classicAlarms, excerptFileName: "ringtone_classic_bedsideclock.caf", fullTrackFileName: "ringtone_classic_bedsideclock.caf", excerptDuration: 1.0),
        Ringtone(id: "classic.digitalalarm", displayNameKey: "ringtone_classic_digitalalarm", section: .classicAlarms, excerptFileName: "ringtone_classic_digitalalarm.caf", fullTrackFileName: "ringtone_classic_digitalalarm.caf", excerptDuration: 0.5),
