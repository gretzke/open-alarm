...
enum L10n {
    ...
    static let alarmEditorRepeatEveryDay: LocalizedStringKey = "alarm_editor_repeat_every_day"
    static let alarmEditorRepeatWeekdays: LocalizedStringKey = "alarm_editor_repeat_weekdays"
    static let alarmEditorRepeatWeekend: LocalizedStringKey = "alarm_editor_repeat_weekend"
